...
public class GaussMain {
    public static void main() {
        ...
        Gauss gausMatrix = new Gauss(matrix16, vector16);
        ...
        if (gausMatrix.linearSystem() == null) {
            System.out.println("Система не имеет решений");
        } else if (gausMatrix.linearSystem().getSize() == 0) {
            System.out.println("Система имеет множество решений");
        } else {
            System.out.println(gausMatrix.linearSystem().toString());
        }
    }
